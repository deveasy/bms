...
<head>
    ...
    <!-- Page Title  -->
    <title><?php echo $title ?> | Budget Monitoring System</title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/dashlite.css?ver=2.9.1">
    <link id="skin-default" rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/theme.css?ver=2.9.1">
</head>
                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/crypto/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="<?php echo base_url(); ?>assets/images/logo.png" srcset="./images/logo2x.png 2x" alt="logo">
                            <img class="logo-dark logo-img" src="<?php echo base_url(); ?>assets/images/logo-dark.png" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                ...
                <div class="nk-sidebar-element">
                    <div class="nk-sidebar-body" data-simplebar>
                        <div class="nk-sidebar-content">
                            <?php $this->load->view('tpl/sidebar_menu'); ?><!-- .nk-sidebar-menu -->
                            <?php $this->load->view('tpl/sidebar_widget'); ?><!-- .nk-sidebar-widget -->
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    ...
                                                    <div class="user-name dropdown-indicator"><?php echo $this->session->userdata['logged_in']['firstname'] . ' ' . $this->session->userdata['logged_in']['lastname']; ?></div>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span class="lead-text"><?php echo $this->session->userdata['logged_in']['firstname'] . ' ' . $this->session->userdata['logged_in']['lastname']; ?></span>
                                                        <span class="sub-text"><?php echo $this->session->userdata['logged_in']['email']; ?></span>
                                                    </div>
                                                </div>
                                            </div>
