                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="<?php echo base_url(); ?>users/add_user"><span>Add User</span></a></li>
                                                                    <li><a href="<?php echo base_url(); ?>users/import_user"><span>Import Users</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <div class="card-inner p-0">
                                            <div class="nk-tb-list nk-tb-ulist">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <a href="html/user-details-regular.html">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-info">
                                                                    <span class="tb-lead"><?php echo $user->firstname.' '.$user->lastname; ?> <span class="dot dot-success d-md-none ml-1"></span></span>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="tb-status  ">Active</span>
                                                    </div>
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            <li class="divider"></li>
                                                                            <li><a href="<?php echo base_url(); ?>"><em class="icon ni ni-shield-star"></em><span>Reset Password</span></a></li>
                                                                            <li><a href="<?php echo base_url(); ?>users/resetPassword"><em class="icon ni ni-na"></em><span>Suspend User</span></a></li>
                                                                            <li><a href="<?php echo base_url(); ?>users/resetPassword"><em class="icon ni ni-cross"></em><span>Delete User</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
